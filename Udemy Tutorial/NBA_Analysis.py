...
FieldGoalsAccuracy = np.matrix.round((FieldGoals / FieldGoalAttempts)*100)
...
#plt.plot(Games[2], c='Green', ls = '--', marker = '^', ms=10, label=Players[2])
#plt.plot(Games[3], c='Blue', ls = '--', marker = 'D', ms=10, label=Players[3])
#plt.plot(Games[4], c='Magenta', ls = '--', marker = 's', ms=10, label=Players[4])
#plt.plot(Games[5], c='Black', ls = '--', marker = 'o', ms=10, label=Players[5])
#plt.plot(Games[6], c='Red', ls = '--', marker = '^', ms=10, label=Players[6])
#plt.plot(Games[7], c='Green', ls = '--', marker = 'D', ms=10, label=Players[7])
#plt.plot(Games[8], c='Blue', ls = '--', marker = 's', ms=10, label=Players[8])
#plt.plot(Games[9], c='Magenta', ls = '--', marker = 'o', ms=10, label=Players[9])
#plt.legend(loc='upper left', bbox_to_anchor=(1,1)) # Adding Legend
...
def myplot(data, playerlist = Players):
    ...
    mark = {"KobeBryant": "s", "JoeJohnson": "o", "LeBronJames": "^", "CarmeloAnthony": "D", "DwightHoward": "s", "ChrisBosh": "o", 
           "ChrisPaul": "^", "KevinDurant": "D", "DerrickRose":"s", "DwayneWade": "o"}
    for name in playerlist:
        plt.plot(data[Pdict[name]], c=col[name], ls = '--', marker = mark[name], ms=10, label=name)
    plt.legend(loc='upper left', bbox_to_anchor=(1,1)) # Adding Legend
    plt.xticks(list(range(0,10)), Seasons, rotation='vertical')
    plt.show()
